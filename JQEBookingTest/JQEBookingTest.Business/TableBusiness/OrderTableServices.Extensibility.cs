...
namespace JQEBookingTest.Business.TableBusiness
{
    ...
    public partial class OrderTableServices:IOrderTableServices,IDisposable
    {
        ...
        {
            return dataAccess.GetOrderTableExtend(dbType, orderTableShowFields, ticketTypeShowFields, whereFields, orderFields, pageSize, pageIndex, mainTableName, joinTableName, joinCondition);
        }
    }
}
