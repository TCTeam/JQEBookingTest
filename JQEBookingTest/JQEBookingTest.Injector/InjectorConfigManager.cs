//-----------------------------------------------------------------------
// <copyright company="同程网" file="InjectorConfigManager.cs">
//    Copyright (c)  V1.0
...
namespace JQEBookingTest.Injector
{
    ...
    /// 逻辑配置文件管理类
    /// </summary>
    internal class InjectorConfigManager
    {
        /// <summary>
        /// 锁定对象
        /// </summary>
        ...
        /// 配置文件路径
        /// </summary>
        private static string ConfigFilePath = AppDomain.CurrentDomain.BaseDirectory + "App_Data\\TCConfig\\TCSmartFramework.Injector.config";

        /// <summary>
        /// 反射文件路径
        /// </summary>
        private static string BusinessFilePath = AppDomain.CurrentDomain.BaseDirectory + "App_Data\\TCBusiness";
