//-----------------------------------------------------------------------
// <copyright company="同程网" file="MakeCheckCode.cs">
//    作者：asp.net全体组员
//    功能：验证码相关
//-----------------------------------------------------------------------
using System;
...
{
    public MakeCheckCode()
    {
    }
    //画图，供web页面调用
    public string DrawImage()
    {
        MakeCheckCode img = new MakeCheckCode();
        HttpContext.Current.Session["CheckCode"] = img.CreateValidateCodeContext(4);
